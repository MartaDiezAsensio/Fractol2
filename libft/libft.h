...
/*   Updated: 2023/09/19 18:11:15 by mdiez-as         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
s_list			*ft_lstnew(void const *content, size_t content_size);
...
void			ft_lstadd(s_list **alst, s_list *new);
void			ft_lstiter(s_list *lst, void (*f)(s_list *elem));
s_list			*ft_lstmap(s_list *lst, s_list *(*f)(s_list *elem));
void			ft_lstrev(s_list **alst);
size_t			ft_lstcount(s_list *lst);
s_list			*ft_lstat(s_list *lst, size_t val);
